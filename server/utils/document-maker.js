...
export default class DocumentCreator {
    ...
    static createContactInfo(phoneNumber, profileUrl, email) {
    ...
    static createRoleText(roleText) {
        return new Paragraph({
            children: [
                new TextRun({
                    text: roleText,
    ...
    // tslint:disable-next-line:no-any
    static createAchivementsList(achivements) {
    ...
    static splitParagraphIntoBullets(text) {
        return text.split("\n\n");
    }

    // tslint:disable-next-line:no-any
    static createPositionDateText(startDate, endDate, isCurrent) {
