...
export default class Constants {
  ...
  Instructions: Generate a JSON structure based on the provided text. Organize the JSON according to the pattern specified in ${this.templateToFollow}. The criteria for mapping data to JSON keys are as follows:
